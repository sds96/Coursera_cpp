...
void Test3(){
	...
	ASSERT_EQUAL(ComputeStats(single).unemployed_females, 10);
	ASSERT_EQUAL(ComputeStats(single).employed_males, 21);
	ASSERT_EQUAL(ComputeStats(single).unemployed_males, 20);
}
