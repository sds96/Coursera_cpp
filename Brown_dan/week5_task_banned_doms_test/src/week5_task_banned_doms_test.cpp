...
void TestSimple() {
    // Your tests here
	TestSplitWithExcessEmpty();
	TestDomainReversedParts();
	TestIsSubdomainNonReflexive();
	TestIsSubdomainMixedArgs();
	TestDomainCheckerNoAbsorbation();
	TestCheckDomainsInvertBool();
	TestPrintCheckResultsGoodOrBad();
	TestReadDomainsExcessEmpty();
 }
