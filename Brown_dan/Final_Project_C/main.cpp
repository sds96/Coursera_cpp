...
void Test_Coursera3(){
	...
	Read_DataBase(bm, ss);
	Answer_DataBase(bm, ss, os);
	string correct("Bus 256: 6 stops on route, 5 unique stops, 5950.000000 route length, 1.361239 curvature\n"
...
int main() {
	...
	//RUN_TEST(tr, Test_ReadBus);  // should't work here
	//RUN_TEST(tr, Test_Coursera); // should't work here
	//RUN_TEST(tr, Test_Coursera2); // should't work here
